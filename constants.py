...
#               ->  75% 3x-S&P500   +   25% 1x-BTC   (BTC NUR im Markt-Regime, kein B&H)
#     sonst  ->  100% CASH
#
...
#     BTC-Anteil 25%              (final von Patrick gewaehlt; SORTINO-basiert.
#                                  75/25 = etwas defensiver als 70/30; BTC bleibt
#                                  reine 25%-Halteposition IM MARKT-Regime (kein
#                                  eigenes BTC-Signal, kein Buy&Hold). Sharpe bewusst
